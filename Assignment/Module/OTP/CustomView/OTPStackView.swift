...
class OTPStackView: UIStackView {
    ...
    let activeFieldBorderColor = UIColor(named: "colorBlue")!//UIColor.blue
...
//        for (index, fields) in textFieldsCollection.enumerated() {
//            print("\(index) next: \(fields.nextTextField) prev: \(fields.previousTextField)")
//        }
...
//        if let castedOTPTextField = textField as? OTPTextField,
//           castedOTPTextField.nextTextField == nil {
//
//        }
